...
namespace backend.Migrations
{
    ...
    [Migration("20250626104201_CreateKalendarTable")]
    partial class CreateKalendarTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Planiranje", b =>
                {
                    ...
                    b.HasOne("backend.Models.Strojevi", "Strojevi")
                        .WithMany()
                        .HasForeignKey("StrojeviId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Stroj");

                    b.Navigation("Strojevi");
                });
